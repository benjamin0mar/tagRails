...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { fecha_final: @test.fecha_final, fecha_inicio: @test.fecha_inicio } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { fecha_final: @test.fecha_final, fecha_inicio: @test.fecha_inicio } }
